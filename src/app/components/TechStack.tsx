...
export default function TechStack() {
  return (
    <div className="flex flex-row flex-wrap gap-3 mt-2">
      ...
      <Image data-tooltip-id='tooltip' data-tooltip-content="NextJS" data-tooltip-place="bottom" src="/nextjs.svg" alt="nextjs icon" width={35} height={35}/>
      <Image data-tooltip-id='tooltip' data-tooltip-content="NodeJS" data-tooltip-place="bottom" src="/node.svg" alt="node icon" width={35} height={35}/>
